...
module Contentqa
  class SearchController < ApplicationController
    ...
    FACETS = %w[sourceResource.type sourceResource.format sourceResource.language.name sourceResource.spatial.name sourceResource.spatial.state sourceResource.spatial.city sourceResource.subject.name sourceResource.collection.title sourceResource.contributor intermediateProvider dataProvider rights]
